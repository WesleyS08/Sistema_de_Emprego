        ...
        <div class="container">
            <div class="divPesquisa">
                ...
                <div id="mostraFiltros">
                    <h3>Filtros</h3>
                    <img id="iconeFiltro" src="../../../assets/images/icones_diversos/showVisible.svg">
                </div>
        ...
        $(document).ready(function () {
            ...
            $('.inputPesquisa').on('input', function () {
                ...
                if (searchTerm.length >= 2) {
                    $.ajax({
                        url: '../../../services/Filtros/TodosAnuncios/obter_sugestoes.php',
                        method: 'POST',
                        data: {
                            termo: searchTerm,
                            area: areaAtual 
            ...
            function buscarVagasPorTitulo(termoPesquisa, area) {
                $.ajax({
                    url: '../../../services/Filtros/TodosAnuncios/buscar_vaga_por_titulo.php',
                    method: 'POST',
                    data: {
                        termo: termoPesquisa,
                        area: area
    ...
    <script>
        $(document).ready(function () {
            ...
            function aplicarFiltros() {
                ...
                $.ajax({
                    url: '../../../services/Filtros/TodosAnuncios/buscar_vagas_filtros.php',
                    method: 'POST',
                    data: {
                        area: area,
                        tipos: tipos,
